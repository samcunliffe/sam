...
pid_variables = [
    ...
    # bdts
    PidVariable("bdt01", "BDT 01 response", (50, -1.1, 1.1), "BDTFreezeDec13_01"),
    PidVariable("bdt02", "BDT 02 response", (50, -1.1, 1.1), "BDTFreezeDec13_02"),
    PidVariable("bdt03", "BDT 03 response", (50, -1.1, 1.1), "BDTFreezeDec13_03"),
    PidVariable("bdt04", "BDT 04 response", (50, -1.1, 1.1), "BDTFreezeDec13_04"),
    PidVariable("bdt05", "BDT 05 response", (50, -1.1, 1.1), "BDTFreezeDec13_05"),
    PidVariable("bdt06", "BDT 06 response", (50, -1.1, 1.1), "BDTFreezeDec13_06"),
    PidVariable("bdt07", "BDT 07 response", (50, -1.1, 1.1), "BDTFreezeDec13_07"),
    PidVariable("bdt08", "BDT 08 response", (50, -1.1, 1.1), "BDTFreezeDec13_08"),
    PidVariable("bdt09", "BDT 09 response", (50, -1.1, 1.1), "BDTFreezeDec13_09"),
    PidVariable("bdt10", "BDT 10 response", (50, -1.1, 1.1), "BDTFreezeDec13_10"),
